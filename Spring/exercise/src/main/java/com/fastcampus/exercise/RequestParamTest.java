...
//		http://localhost/ch2/requestParam2?year    ---->> year=""
	...
	// @RequestParam을 붙이면 반드시 요청되어야 함, required=true가 생략되어 있음
...
//		http://localhost/ch2/requestParam3?year    ---->> year=""
	...
	// @RequestParam을 붙이면 반드시 요청되어야 함, required=false

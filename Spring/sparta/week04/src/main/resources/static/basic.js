...
function addHTML(itemDto) {
    ...
    return `<div class="search-itemDto">
            ...
            <div class="search-itemDto-right">        <!-- json값을 넘기기 때문에 문자열로 만들고 넘김 ( -->
                <img src="images/icon-save.png" alt="" onclick='addProduct(${JSON.stringify(itemDto)})'>
            </div>                                   <!-- json값을 함수의 매개변수로 넘길때는 문자열로 넘겨야 함! -->
        </div>`
}
...
function addProduct(itemDto) {
    ...
    $.ajax({
        type: "POST",
        url: "/api/products",
        data: JSON.stringify(itemDto),  // 문자열로 넘겨받았지만, js가 json화 하기 때문에 다시 문자열로 넘김
